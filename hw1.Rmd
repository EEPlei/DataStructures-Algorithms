...
is_valid(bad_g3)
```
This will also return false, because if you look at vertex B$edges, you can see that it goes to 1L and 3L. 1L would be the first vertex in the list, so A but 3L is linking to the third vertex when it doesn't exist in bad_g3. 
