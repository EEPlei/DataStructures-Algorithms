...
`is_valid(graph1)` should return TRUE since as you can see from the graphic above, graph1 fits all the criterion of a valid graph. Since I know graph1 to be valid, it might be useful to run `edge_summarygraph1)` just to have a better picture of what the graph looks like. 
